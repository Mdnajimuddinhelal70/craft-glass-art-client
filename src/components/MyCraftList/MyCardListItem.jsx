...
const MyCardListItem = ({item}) => {
    const {_id, image, itemName, description, userName, price, raiting, processingTime, subcategoryName, stockStatus, email } = item;
    return (
      ...
      <div className="card card-side bg-white shadow-lg rounded-lg overflow-hidden max-w-4xl w-full">
        ...
        <div className="card-body p-6 w-1/2">
          ...
          <div className="mb-4">
            ...
            <div>
               <Link to={`/myLitsUpdate/${_id}`}> <button className="btn btn-accent">Update</button></Link>
